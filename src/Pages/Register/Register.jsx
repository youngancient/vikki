      ...
      <div className="form">
        <form>
          <div className="form-ele">
            ...
            <input type="text" name="name" id="" className="form-i input-txt" />
          ...
          <div className="form-ele">
            ...
            <p className="error">Email cannot be empty or invalid</p>
          </div>
          <div className="form-ele">
            ...
            <p className="info">Contain at least 8 characters</p>
          </div>
          <div className="fp">
        ...
        <div className="footer">
          <p className="input-txt">Already have an account?</p>
          <Link to="/login" className="purple">
            Sign in
          </Link>
        </div>
      </div>
